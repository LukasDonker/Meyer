...
<t:button id="g_45" actionListener="#{d.ContentWindowUI.onNeuServiceBericht}" font="weight:bold" foreground="#ffffff" stylevariant="primaryButton" text="Neuer Servicebericht" width="150" />
...
<t:autocomplete id="g_99" actionListener="#{d.ContentWindowUI.onSearch}" comment="Suche" height="30" placeholder="TSNummer, Kunde, Disponent, Gebiet, Techniker" textimage="/awesomefont(f002,#000000,14)" value="#{d.ContentWindowUI.autofill}" valuesurl="#{d.ContentWindowUI.autofillListACURL}" width="350" withfocusevent="true" />
<t:button id="g_100" actionListener="#{d.ContentWindowUI.onSearch}" font="weight:bold" foreground="#ffffff" height="30" text="Suchen" />
</t:rowadaptiveline>
</t:pane>
</t:rowtitlebar>
