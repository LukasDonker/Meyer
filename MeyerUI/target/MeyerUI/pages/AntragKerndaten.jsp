...
<t:textwithlinks id="g_25" text="Musterkunde &lt;br&gt; Musterstraße 123 &lt;br&gt; 11111 Musterstadt" width="200" />
</t:row>
</t:pane>
...
<t:calendarfield id="g_30" exacttime="true" flush="true" format="datetime" formatmask="short" width="100%;150" />
</t:row>
</t:pane>
</t:rowadaptiveline>
...
<t:toggle id="g_129" actionListener="#{d.AntragKerndatenUI.weitererEinsatz}" flush="true" />
